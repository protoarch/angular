...
describe('AuthorizeControlDirective', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [AuthorizeControlDirective, TestAuthorizeControlComponent],
  ...
  it('should disable control', () => {
    ...
    expect(fixture.nativeElement.children[1].attributes.disabled.value).toBe(
      'true'
    );
    expect(fixture.nativeElement.children[1].attributes.style.value).toBe(
  ...
  it("shouldn't disable control", () => {
    ...
    expect(
      fixture.nativeElement.children[1].attributes.disabled
    ).toBeUndefined();
  ...
  it("shouldn't affect on disabling binding (false)", () => {
    ...
    fixture.detectChanges();
    expect(
      fixture.nativeElement.children[3].attributes.disabled
    ).toBeUndefined();
  });
});
